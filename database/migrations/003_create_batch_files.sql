...
-- Links downloaded files to their assigned batches
...
-- Comments
COMMENT ON TABLE batch_files IS 'Junction table linking files to batches';
COMMENT ON COLUMN batch_files.processing_status IS 'Per-file processing status within the batch';
